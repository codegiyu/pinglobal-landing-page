  ...
  return (
    <section id="regulatories" className="py-24 bg-gradient-subtle">
      <div className="regular-container">
        ...
        <div className="flex flex-col xs:flex-row items-center justify-center gap-8">
...
const RegulatoryCard = ({ img, name }: RegulatoryCardProps) => {
  return (
    <Card className="w-[320px] flex-none p-8 text-center shadow-pin-card hover:shadow-pin-button transition-all duration-300 hover:scale-105 border-pin-gray-light">
